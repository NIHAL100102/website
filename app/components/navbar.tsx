                ...
                <div className="flex items-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium">
                     <span className="font-bold text-blue-700 dark:text-white"> NIHAL</span>  <span className="dark:text-blue-700 font-bold">DEVADIGA</span>
                    </h1>
                  </Link>
                </div>
                  ...
                  <Link
                    ...
                    className={`${
                      pathname === "/"
                        ...
                        : "border-transparent text-gray-500 dark:text-blue-300 dark:hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    }`}
                  >
                    Home
                  </Link>
              ...
              <Link
                ...
                className={`${
                  pathname == "/"
                    ...
                    : "border-transparent text-gray-500 hover:bg-blue-50 hover:border-gray-300 hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-blue-700 border-l-4 text-base font-medium dark:text-white"
                } `}
              >
                Home
              </Link>
